...
interface ISwapRouterInterface extends ethers.utils.Interface {
  functions: {
    ...
    'cytoswapV3SwapCallback(int256,int256,bytes)': FunctionFragment
  }
  ...
  encodeFunctionData(functionFragment: 'cytoswapV3SwapCallback', values: [BigNumberish, BigNumberish, BytesLike]): string
  ...
  decodeFunctionResult(functionFragment: 'cytoswapV3SwapCallback', data: BytesLike): Result
...
export class ISwapRouter extends Contract {
  ...
  functions: {
    ...
    'cytoswapV3SwapCallback(int256,int256,bytes)'(
      amount0Delta: BigNumberish,
      amount1Delta: BigNumberish,
      data: BytesLike,
      overrides?: Overrides
