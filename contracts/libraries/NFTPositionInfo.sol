...
library NFTPositionInfo {
    /// @param factory The address of the Cytoswap V3 Factory used in computing the pool address
    ...
    /// @return pool The address of the Cytoswap V3 pool
    /// @return tickLower The lower tick of the Cytoswap V3 position
