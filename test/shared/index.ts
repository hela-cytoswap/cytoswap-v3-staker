...
import { ICytoswapV3Pool, TestERC20 } from '../../typechain'
...
export const getSlot0 = async (pool: ICytoswapV3Pool) => {
  if (!pool.signer) {
...
export const getCurrentTick = async (pool: ICytoswapV3Pool): Promise<number> => (await getSlot0(pool)).tick
